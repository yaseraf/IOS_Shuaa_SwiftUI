//
//  LogoutConfirmaitonContentView.swift
//  QSC_SwiftUI
//
...
struct LogoutConfirmaitonContentView: View {
...
//                Spacer()
                ...
                VStack{
                    CustomButton(type: .primary, title: "log_out".localized,onTap:  {
                        onDoneTap()
                     })
                     .frame(height: 50)
