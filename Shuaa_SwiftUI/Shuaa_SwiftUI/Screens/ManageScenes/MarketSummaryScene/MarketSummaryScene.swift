...
struct MarketSummaryScene: BaseSceneType {
    @ObservedObject var viewModel: MarketSummaryViewModel
    ...
    var body: some View {
        BaseScene(contentView: {
            BaseContentView(withScroll:false, paddingValue: 0, content: {
                MarketSummaryContentView(marketSummaryData: $viewModel.marketSummaryData, onBackTap: {
                    viewModel.onBackTap()
                })
                .onAppear {
