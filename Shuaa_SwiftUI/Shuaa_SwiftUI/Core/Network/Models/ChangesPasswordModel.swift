...
struct ChangesPasswordRequestModel: Codable {
    var deviceID: String?
...
struct ChangesPasswordResponseModel: Codable {
    var brokerID: String?
    var curCode: String?
    var compInit: String?
    var email: String?
