...
struct AddAlertsRequestModel: Codable {
    
}

struct AddAlertsResponseModel: Codable {
    let alertCondition, alertID, bySMS, condition: String?
        let conditionName, conditionValue, customMsg, exchange: String?
        let executed, notificationAction, symbol, validity: String?
        let webcode: String?
